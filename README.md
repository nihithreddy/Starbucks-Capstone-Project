...
-   **[Starbucks_Capstone_notebook.ipynb](https://github.com/nihithreddy/Starbucks-Capstone-Project/blob/main/Starbucks_Capstone_notebook.ipynb)**: This is the Jupyter Notebook in which I performed all my work.
-   **[data](https://github.com/nihithreddy/Starbucks-Capstone-Project/tree/main/data)**: This contains the three JSON files provided by Starbucks / Udacity as noted above.
